...
def compute_facroc(auccResult_protected, auccResult_non_protected, 
                  protected_attribute="Gender", protected="Female", 
                  non_protected="Male", showPlot=True, filename=None):
