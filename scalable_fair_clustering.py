...
DATASET_CONFIGS = {
    ...
    'communities-crime-encode.csv': {'k': 4, 'p': 2, 'q': 5},
...
PROTECTED_ATTRIBUTES = {
    ...
    'communities-crime-encode.csv': {'column': 'Black', 'mapping': {0: 0, 1: 1}},
    'pisa-encode.csv': {'column': 'gender', 'mapping': {'F': 0, 'M': 1}},
    'compas-encode.csv': {'column': 'race', 'mapping': {'White': 0, 'Non-White': 1}},
    'oulad-encode.csv': {'column': 'gender', 'mapping': {'M': 0, 'F': 1}},
