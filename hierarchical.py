...
def hierarchical_clustering(input_file, output_file, k=2, linkage='ward'):
    """
    Apply Hierarchical clustering to a dataset.
    ...
    print(f"\n3. Applying Hierarchical clustering with k={k}, linkage={linkage}...")
...
def process_all_datasets():
    """
    Process all datasets in data-encoded directory with Hierarchical clustering.
    """
    dataset_configs = {
    ...
    print("Processing all datasets with Hierarchical clustering...")
    print("=" * 80)
